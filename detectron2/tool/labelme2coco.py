...
################################### README #####################################
'''
    this file is to translate labelme to coco format 
'''
################################################################################
...
class labelme2coco(object):
    ...
    def data_transfer(self):
        for num, json_file in enumerate(natsorted(self.labelme_json)):
            print(json_file)
...
### python lebelme2coco.py {labelme_imgs_dir}  -o {output_dir}
